...
namespace UiPathTeam.JSONUtilities.Activities
{
	/// <summary>
	///     UiPathTeam.JSONUtilities AsyncTaskCodeActivity with result <T>
	/// </summary>
	public abstract class AsyncTaskCodeActivity<T> : AsyncCodeActivity, IDisposable
	{
		...
		protected override IAsyncResult BeginExecute(AsyncCodeActivityContext context, AsyncCallback callback, object state)
		{
			...
			//var property = context.DataContext.GetProperties()[ParentScope.ParentContainerPropertyTag];
	...
	/// <summary>
	///     UiPathTeam.JSONUtilities AsyncTaskCodeActivity without result
	/// </summary>
